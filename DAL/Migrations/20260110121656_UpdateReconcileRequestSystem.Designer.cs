...
namespace DAL.Migrations
{
    ...
    [Migration("20260110121656_UpdateReconcileRequestSystem")]
    partial class UpdateReconcileRequestSystem
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DAL.Data.Models.IdentityModels.Supervisor", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DAL.Data.Models.ReconcileRequest", b =>
                {
                    ...
                    b.Property<DateTime?>("AssignedToMediationAt")
                        .HasColumnType("datetime2");

                    b.Property<DateTime?>("AssignedToSupervisorAt")
                        .HasColumnType("datetime2");
                    ...
                    b.Property<int>("ReconcileRequestTypeId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("MediationId");

                    b.HasIndex("ReconcileRequestTypeId");
            ...
            modelBuilder.Entity("DAL.Data.Models.ReconcileRequestAttachment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("ReconcileRequestId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ReconcileRequestId");

                    b.ToTable("ReconcileRequestAttachments");
                });

            modelBuilder.Entity("DAL.Data.Models.ReconcileRequestType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("ReconcileRequestTypes");
                });
            ...
            modelBuilder.Entity("DAL.Data.Models.IdentityModels.Supervisor", b =>
                {
                    b.HasOne("DAL.Data.Models.IdentityModels.ApplicationUser", "User")
                        .WithOne("Supervisor")
                        .HasForeignKey("DAL.Data.Models.IdentityModels.Supervisor", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("DAL.Data.Models.ReconcileRequest", b =>
                {
                    b.HasOne("DAL.Data.Models.IdentityModels.Mediation", "Mediation")
                        .WithMany("ReconcileRequests")
                        .HasForeignKey("MediationId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("DAL.Data.Models.ReconcileRequestType", "ReconcileRequestType")
                        .WithMany("ReconcileRequests")
                        .HasForeignKey("ReconcileRequestTypeId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("DAL.Data.Models.IdentityModels.Supervisor", "Supervisor")
                        .WithMany("ReconcileRequests")
                    ...
                    b.Navigation("ReconcileRequestType");
            ...
            modelBuilder.Entity("DAL.Data.Models.ReconcileRequestAttachment", b =>
                {
                    b.HasOne("DAL.Data.Models.ReconcileRequest", "ReconcileRequest")
                        .WithMany("Attachments")
                        .HasForeignKey("ReconcileRequestId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("ReconcileRequest");
                });
            ...
            modelBuilder.Entity("DAL.Data.Models.IdentityModels.Mediation", b =>
                {
                    b.Navigation("ReconcileRequests");
                });
